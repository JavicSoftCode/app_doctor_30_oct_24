...
class TipoSangre(models.Model):
  ...
  tipo = models.CharField(max_length=3, choices=SANGRE_TYPE_CHOICES, verbose_name="Tipo Sangre", unique=True)
...
class Especialidad(models.Model):
  ...
  nombre = models.CharField(max_length=100, verbose_name="Nombre de la Especialidad", unique=True)
...
class Doctor(models.Model):
  # Nombre del doctor
  nombres = models.CharField(max_length=100, verbose_name="Nombres", validators=[validate_full_name])
  # Apellido del doctor
  apellidos = models.CharField(max_length=100, verbose_name="Apellidos", validators=[validate_full_name])
  ...
  codigoUnicoDoctor = models.CharField(max_length=12, unique=True, verbose_name="Código Único del Doctor",
  ...
  telefonos = models.CharField(max_length=20, verbose_name="Teléfonos", unique=True,
                               validators=[validate_and_format_cell_number])
...
class Empleado(models.Model):
  ...
  # Sueldo del empleado
  sueldo = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Sueldo", validators=[validate_sueldo])
  ...
  curriculum = models.FileField(upload_to='curriculumsEmpleado/', verbose_name="Curriculum Vitae", null=True,
                                blank=True)
  firma_digital = models.ImageField(upload_to='firmasEmpleado/', verbose_name="Firma Digital", null=True, blank=True)
  telefonos = models.CharField(max_length=20, verbose_name="Teléfonos", unique=True,
                               validators=[validate_and_format_cell_number])
  email = models.EmailField(verbose_name="Correo", null=True, blank=True, unique=True)
  activo = models.BooleanField(default=True, verbose_name="Activo")
...
class Medicamento(models.Model):
  # tipo de medicamento
  image = models.ImageField(upload_to='medicamentos/', verbose_name="Foto", null=True, blank=True)
  ...
  cantidad = models.PositiveIntegerField(verbose_name="Stock", validators=[validate_cantidad])
  # Precio del medicamento
  precio = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Precio", validators=[validate_precio])
  ...
  def get_image(self):
    if self.image:
      ...
      return '/static/img/avatar_medicamento.jpg'
